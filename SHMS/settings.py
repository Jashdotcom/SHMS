...
ASGI_APPLICATION = 'SHMS.asgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "no-reply@shms.local")
...
BOOKING_EXPIRY_HOURS = int(os.getenv("BOOKING_EXPIRY_HOURS", "24"))
